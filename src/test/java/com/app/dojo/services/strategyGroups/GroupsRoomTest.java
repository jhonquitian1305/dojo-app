...
class GroupsRoomTest {
  @InjectMocks
  private GroupsRoom groups;
  @Mock
  ...
  @Test
  @DisplayName("Test GroupsStrategy, Test to get all groups by room")
  void findGroups() throws Exception {
    //given
    Page<GroupClass> groups=new PageImpl<>(List.of(group));
    Pageable pageable= PageRequest.of(1,10);
    given(this.groupClassRepository.findByRooms(room,pageable)).willReturn(groups);
